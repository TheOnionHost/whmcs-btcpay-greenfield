...
1. Copy `modules/gateways/btcpaygreenfield.php`, `modules/gateways/btcpaygreenfield/`, and `modules/gateways/callback/btcpaygreenfield.php` into your WHMCS `modules/gateways/` tree.
